document.addEventListener("DOMContentLoaded", () => {
    ...
    if (petId) {
        ...
        alert("ไม่พบข้อมูลสัตว์ กรุณากลับไปเลือกใหม่อีกครั้ง");
        window.location.href = "petlisting.html";
        return; // เพิ่ม return เพื่อหยุดการทำงานหากไม่พบ petId
    }

    // -------------------------------
    // 2) ตรวจสอบ inputs เพื่อเปลี่ยนสีปุ่ม submit
    // -------------------------------
